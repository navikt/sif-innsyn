        ...
        søknad: {
            ...
            frilans: {
                ...
                arbeidsforhold: {
                    arbeidIPeriode: {
                        ...
                        arbeidsuker: [
                            { periode: { fraOgMed: '2022-10-10', tilOgMed: '2022-10-13' }, prosentAvNormalt: 20 },
                        ],
            ...
            k9FormatSøknad: {
                ...
                ytelse: {
                    ...
                    tilsynsordning: { perioder: { '2022-10-03/2022-10-13': { etablertTilsynTimerPerDag: 'PT0S' } } },
                    endringsperiode: [],
        ...
        søknad: {
            ...
            k9FormatSøknad: {
                ...
                ytelse: {
                    ...
                    tilsynsordning: { perioder: { '2022-10-01/2022-10-30': { etablertTilsynTimerPerDag: 'PT0S' } } },
                    endringsperiode: [],
                    lovbestemtFerie: { perioder: {} },
        ...
        søknad: {
            ...
            arbeidsgivere: [
                {
                    ...
                    arbeidsforhold: {
                        arbeidIPeriode: {
                            ...
                            enkeltdager: [
                                { dato: '2022-08-09', arbeidstimer: { normalTimer: 'PT4H', faktiskTimer: 'PT0S' } },
                                { dato: '2022-08-10', arbeidstimer: { normalTimer: 'PT4H', faktiskTimer: 'PT0S' } },
                                { dato: '2022-08-15', arbeidstimer: { normalTimer: 'PT4H', faktiskTimer: 'PT0S' } },
                                { dato: '2022-08-16', arbeidstimer: { normalTimer: 'PT4H', faktiskTimer: 'PT0S' } },
                                { dato: '2022-08-17', arbeidstimer: { normalTimer: 'PT4H', faktiskTimer: 'PT3H' } },
                                { dato: '2022-08-22', arbeidstimer: { normalTimer: 'PT4H', faktiskTimer: 'PT0S' } },
                                { dato: '2022-08-23', arbeidstimer: { normalTimer: 'PT4H', faktiskTimer: 'PT0S' } },
                                { dato: '2022-08-24', arbeidstimer: { normalTimer: 'PT4H', faktiskTimer: 'PT3H' } },
                                { dato: '2022-08-29', arbeidstimer: { normalTimer: 'PT4H', faktiskTimer: 'PT0S' } },
                                { dato: '2022-08-30', arbeidstimer: { normalTimer: 'PT4H', faktiskTimer: 'PT0S' } },
                                { dato: '2022-08-31', arbeidstimer: { normalTimer: 'PT4H', faktiskTimer: 'PT3H' } },
                                { dato: '2022-09-05', arbeidstimer: { normalTimer: 'PT4H', faktiskTimer: 'PT0S' } },
                                { dato: '2022-09-06', arbeidstimer: { normalTimer: 'PT4H', faktiskTimer: 'PT0S' } },
                                { dato: '2022-09-07', arbeidstimer: { normalTimer: 'PT4H', faktiskTimer: 'PT3H' } },
                            ],
                            arbeiderIPerioden: 'REDUSERT',
                        },
                        normalarbeidstid: {
            ...
            k9FormatSøknad: {
                ...
                ytelse: {
                    ...
                    tilsynsordning: { perioder: { '2022-08-09/2022-09-10': { etablertTilsynTimerPerDag: 'PT0S' } } },
                    endringsperiode: [],
                    lovbestemtFerie: { perioder: {} },
    ...
    },
    {
        ...
        søknad: {
            ...
            medlemskap: {
                ...
                harBoddIUtlandetSiste12Mnd: false,
                utenlandsoppholdNeste12Mnd: [
                    { fraOgMed: '2022-11-23', landkode: 'ASM', landnavn: 'Amerikansk Samoa', tilOgMed: '2022-12-23' },
                ],
                utenlandsoppholdSiste12Mnd: [],
            },
            harMedsøker: false,
            ...
            k9FormatSøknad: {
                ...
                ytelse: {
                    ...
                    omsorg: {},
                    bosteder: { perioder: { '2022-11-23/2022-12-23': { land: 'ASM' } }, perioderSomSkalSlettes: {} },
                    beredskap: { perioder: {}, perioderSomSkalSlettes: {} },
                    nattevåk: { perioder: {}, perioderSomSkalSlettes: {} },
                    arbeidstid: {
                        arbeidstakerList: [
                    ...
                    tilsynsordning: { perioder: { '2022-11-01/2022-11-19': { etablertTilsynTimerPerDag: 'PT0S' } } },
                    endringsperiode: [],
                    lovbestemtFerie: { perioder: {} },
    ...
    },
    {
        ...
        søknad: {
            ...
            medlemskap: {
                ...
                utenlandsoppholdNeste12Mnd: [
                    { fraOgMed: '2022-09-02', landkode: 'ASM', landnavn: 'Amerikansk Samoa', tilOgMed: '2022-11-19' },
                ],
                utenlandsoppholdSiste12Mnd: [
            ...
            k9FormatSøknad: {
                ...
                ytelse: {
                    ...
                    beredskap: {
                        perioder: { '2022-08-01/2022-09-30': { tilleggsinformasjon: 'Beskrivelse av beredskap' } },
                        perioderSomSkalSlettes: {},
                    },
                    nattevåk: {
                        perioder: { '2022-08-01/2022-09-30': { tilleggsinformasjon: 'Beskrivelse av nattevåk' } },
                        perioderSomSkalSlettes: {},
                    },
                    arbeidstid: {
                        arbeidstakerList: [
        ...
        søknad: {
            ...
            arbeidsgivere: [
                {
                    ...
                    arbeidsforhold: {
                        arbeidIPeriode: {
                            type: 'ARBEIDER_ENKELTDAGER',
                            enkeltdager: [
                                { dato: '2022-09-01', arbeidstimer: { normalTimer: 'PT2H', faktiskTimer: 'PT0S' } },
                                { dato: '2022-09-02', arbeidstimer: { normalTimer: 'PT2H', faktiskTimer: 'PT0S' } },
                                { dato: '2022-09-05', arbeidstimer: { normalTimer: 'PT2H', faktiskTimer: 'PT1H' } },
                                { dato: '2022-09-06', arbeidstimer: { normalTimer: 'PT2H', faktiskTimer: 'PT5H' } },
                                { dato: '2022-09-07', arbeidstimer: { normalTimer: 'PT2H', faktiskTimer: 'PT0S' } },
                                { dato: '2022-09-08', arbeidstimer: { normalTimer: 'PT2H', faktiskTimer: 'PT0S' } },
                                { dato: '2022-09-09', arbeidstimer: { normalTimer: 'PT2H', faktiskTimer: 'PT0S' } },
                                { dato: '2022-09-12', arbeidstimer: { normalTimer: 'PT2H', faktiskTimer: 'PT0S' } },
                                { dato: '2022-09-13', arbeidstimer: { normalTimer: 'PT2H', faktiskTimer: 'PT5H' } },
                                { dato: '2022-09-14', arbeidstimer: { normalTimer: 'PT2H', faktiskTimer: 'PT0S' } },
                                { dato: '2022-09-15', arbeidstimer: { normalTimer: 'PT2H', faktiskTimer: 'PT0S' } },
                                { dato: '2022-09-16', arbeidstimer: { normalTimer: 'PT2H', faktiskTimer: 'PT0S' } },
                            ],
                            arbeiderIPerioden: 'REDUSERT',
                        },
                        normalarbeidstid: {
            ...
            k9FormatSøknad: {
                ...
                ytelse: {
                    ...
                    tilsynsordning: { perioder: { '2022-09-01/2022-09-17': { etablertTilsynTimerPerDag: 'PT0S' } } },
                    endringsperiode: [],
                    lovbestemtFerie: { perioder: {} },
        ...
        søknad: {
            ...
            k9FormatSøknad: {
                ...
                ytelse: {
                    ...
                    tilsynsordning: { perioder: { '2022-09-01/2022-09-30': { etablertTilsynTimerPerDag: 'PT0S' } } },
                    endringsperiode: [],
                    lovbestemtFerie: { perioder: {} },
        ...
        søknad: {
            ...
            k9FormatSøknad: {
                ...
                ytelse: {
                    ...
                    tilsynsordning: { perioder: { '2022-09-08/2022-09-25': { etablertTilsynTimerPerDag: 'PT0S' } } },
                    endringsperiode: [],
                    lovbestemtFerie: { perioder: {} },
        ...
        søknad: {
            ...
            k9FormatSøknad: {
                ...
                ytelse: {
                    ...
                    tilsynsordning: { perioder: { '2022-09-09/2022-09-24': { etablertTilsynTimerPerDag: 'PT0S' } } },
                    endringsperiode: [],
                    lovbestemtFerie: { perioder: {} },
