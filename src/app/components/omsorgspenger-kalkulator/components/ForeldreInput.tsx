...
import { initForelderValue } from '../tempFlytt';
            ...
            {({ field }: FieldProps) => {
                ...
                return (
                    <Input
                        {...field}
                        mini
                        onFocus={markerTekstVedFokus}
                        type="number"
                        className="dagerInput"
                        feil={feil}
                    />
                );
            }}
                ...
                render={(arrayHelpers) => (
                    <>
                            ...
                            <tbody>
                                ...
                                {foreldre.map((forelder, index) => (
                                    <tr key={forelder.id}>
                                        ...
                                        <td valign="top">
                                            <AntallDagerInputFelt
                                                name={`foreldre[${index}].normaldager.dagerTildelt`}
                                            />
                                        </td>
                                        ...
                                        <td valign="top" className="koronabakgrunn">
                                            <AntallDagerInputFelt
                                                name={`foreldre[${index}].koronadager.dagerTildelt`}
                                            />
                                        </td>
                                    </tr>
                                ))}
                        ...
                        <div className="flex flex--justifyCenter">
                            <Flatknapp
                                htmlType="button"
                                onClick={() => arrayHelpers.push(initForelderValue())}
                                mini
                                form="kompakt">
