...
const Resultat: FunctionComponent = () => {
    ...
    const totaltAntallDager = useMemo<number>(
        () => summerDager(...Object.values(omsorgsprinsipper), effektivtOverført),
        [omsorgsprinsipper, effektivtOverført]
    );
    ...
    return (
        <div className="resultatContainer">
            ...
            <div className="resultatHeader">
                ...
                <Element className="dagerOmsorg">{`${totaltAntallDager} ${tekster(
                    'Resultat.DagerOmsorgspenger'
                )}`}</Element>
            </div>
            <table className="tabell tabell--stripet">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td className="koronabakgrunn">
                            {omsorgsprinsipper?.aleneomsorgKroniskSyke.koronadager || '-'}
                        </td>
                    </tr>
                    <tr>
